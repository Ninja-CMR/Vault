...
<template>
    <div class="space-y-8 pb-12">
        ...
        <div v-else class="relative">
            <div class="max-h-[calc(100vh-320px)] overflow-y-auto pr-6 custom-scrollbar">
                <div class="space-y-10 relative">
                    ...
                    <div v-for="(logs, date) in groupedLogs" :key="date" class="space-y-6">
                        <h3 class="text-[12px] font-bold text-zinc-500 uppercase tracking-[0.2em] sticky top-0 bg-black/80 backdrop-blur-md py-4 z-10 flex items-center space-x-3">
